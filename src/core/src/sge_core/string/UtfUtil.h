...
namespace sge {
	//UTF stands for Unicode Transformation Format, and it is a character encoding standard that represents all possible characters in the Unicode character set. UTF-8, UTF-16, and UTF-32 are three common encodings in the UTF family.
	struct UtfUtil {
